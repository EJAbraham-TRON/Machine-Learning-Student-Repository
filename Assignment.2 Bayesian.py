...
# MinMaxScaler for Bayesian classifiers (require non-negative values)
mm_scaler = MinMaxScaler()
X_train_scaled = mm_scaler.fit_transform(X_train)
X_test_scaled  = mm_scaler.transform(X_test)


# DEFINE BAYESIAN CLASSIFIERS
...
print("Evaluation Metrics — Bayesian Classifiers:")
...
plt.suptitle('Confusion Matrices — Bayesian Classifiers', fontweight='bold', fontsize=13)
plt.tight_layout()
plt.show()
...
plt.ylim(0, 1.1)
plt.ylabel('Score')
plt.title('Classifier Performance Comparison — Bayesian Methods')
plt.legend()
plt.tight_layout()
plt.show()
...
print(f"\nBest Bayesian Classifier: {best_name}")
